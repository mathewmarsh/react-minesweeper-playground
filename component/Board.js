...
export default class Board extends React.Component {
  ...
  initBoardData(difficulty, height, width, mines) {
    let x = height;
    let y = width;
    let m = mines;
    switch (difficulty) {
    ...
    this.setState({ mineCount: m });
    let data = this.createEmptyArray(x, y);
    data = this.plantMines(data, x, y, m);
    data = this.getNeighbours(data, x, y);
    return data;
  }
